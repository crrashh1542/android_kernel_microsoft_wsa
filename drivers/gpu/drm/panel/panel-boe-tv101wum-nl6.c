...
static int inx_hj110iz_init(struct mipi_dsi_device *dsi)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0xFF, 0x24);
	mipi_dsi_dcs_write_seq(dsi, 0xFB, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x91, 0x44);
	mipi_dsi_dcs_write_seq(dsi, 0x92, 0x4C);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0x86);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x03, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x0B);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x1D);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x1C);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x0A, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x0B, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x0C, 0x0A);
	mipi_dsi_dcs_write_seq(dsi, 0x0D, 0x0C);
	mipi_dsi_dcs_write_seq(dsi, 0x0E, 0x0D);
	mipi_dsi_dcs_write_seq(dsi, 0x0F, 0x0E);
	mipi_dsi_dcs_write_seq(dsi, 0x10, 0x0F);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x11);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0x1A, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x1B, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x1C, 0x0B);
	mipi_dsi_dcs_write_seq(dsi, 0x1D, 0x1D);
	mipi_dsi_dcs_write_seq(dsi, 0x1E, 0x1C);
	mipi_dsi_dcs_write_seq(dsi, 0x1F, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x0A);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x0C);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x0D);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x0E);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0x0F);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x28, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x29, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x2A, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x2B, 0x03);

	mipi_dsi_dcs_write_seq(dsi, 0x2F, 0x0A);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0x35);
	mipi_dsi_dcs_write_seq(dsi, 0x37, 0xA7);
	mipi_dsi_dcs_write_seq(dsi, 0x39, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x3A, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x3B, 0x32);
	mipi_dsi_dcs_write_seq(dsi, 0x3D, 0x12);

	mipi_dsi_dcs_write_seq(dsi, 0x3F, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0x40, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0x41, 0x40);
	mipi_dsi_dcs_write_seq(dsi, 0x42, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x47, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0x48, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0x4A, 0x45);
	mipi_dsi_dcs_write_seq(dsi, 0x4B, 0x45);
	mipi_dsi_dcs_write_seq(dsi, 0x4C, 0x14);

	mipi_dsi_dcs_write_seq(dsi, 0x4D, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x4E, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0x4F, 0x65);
	mipi_dsi_dcs_write_seq(dsi, 0x55, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x56, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x59, 0x70);
	mipi_dsi_dcs_write_seq(dsi, 0x5A, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x5B, 0x32);
	mipi_dsi_dcs_write_seq(dsi, 0x5C, 0x88);
	mipi_dsi_dcs_write_seq(dsi, 0x5E, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5F, 0x00);

	mipi_dsi_dcs_write_seq(dsi, 0x7A, 0xFF);
	mipi_dsi_dcs_write_seq(dsi, 0x7B, 0xFF);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x1F, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x32);

	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0x32);

	mipi_dsi_dcs_write_seq(dsi, 0x3F, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x40, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x43, 0x00);

	mipi_dsi_dcs_write_seq(dsi, 0x44, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x45, 0x46);

	mipi_dsi_dcs_write_seq(dsi, 0x48, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x49, 0x32);

	mipi_dsi_dcs_write_seq(dsi, 0x5B, 0x80);

	mipi_dsi_dcs_write_seq(dsi, 0x5C, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5D, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x5E, 0x32);

	mipi_dsi_dcs_write_seq(dsi, 0x5F, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x60, 0x32);

	mipi_dsi_dcs_write_seq(dsi, 0x61, 0x46);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x78, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x79, 0xC5);
	mipi_dsi_dcs_write_seq(dsi, 0x7A, 0x0C);
	mipi_dsi_dcs_write_seq(dsi, 0x7B, 0xB0);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xA1);
	mipi_dsi_dcs_write_seq(dsi, 0x02, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0x0A, 0xF4);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x30);
	mipi_dsi_dcs_write_seq(dsi, 0x0C, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x0D, 0x0D);
	mipi_dsi_dcs_write_seq(dsi, 0x0F, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x40);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x58);
	mipi_dsi_dcs_write_seq(dsi, 0x15, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x17, 0xA0);
	mipi_dsi_dcs_write_seq(dsi, 0x18, 0x86);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x1A, 0x31);
	mipi_dsi_dcs_write_seq(dsi, 0x1B, 0x0D);
	mipi_dsi_dcs_write_seq(dsi, 0x1C, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0x2A, 0x0E);
	mipi_dsi_dcs_write_seq(dsi, 0x2B, 0x31);

	mipi_dsi_dcs_write_seq(dsi, 0x1D, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x1E, 0x62);
	mipi_dsi_dcs_write_seq(dsi, 0x1F, 0x62);

	mipi_dsi_dcs_write_seq(dsi, 0x2F, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0x62);
	mipi_dsi_dcs_write_seq(dsi, 0x31, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x32, 0x7F);
	mipi_dsi_dcs_write_seq(dsi, 0x33, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x34, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0x35, 0x67);

	mipi_dsi_dcs_write_seq(dsi, 0x39, 0x0B);
	mipi_dsi_dcs_write_seq(dsi, 0x3A, 0x62);
	mipi_dsi_dcs_write_seq(dsi, 0x3B, 0x06);

	mipi_dsi_dcs_write_seq(dsi, 0xC8, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xC9, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0xCA, 0x4E);
	mipi_dsi_dcs_write_seq(dsi, 0xCB, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xA9, 0x3F);
	mipi_dsi_dcs_write_seq(dsi, 0xAA, 0x3E);
	mipi_dsi_dcs_write_seq(dsi, 0xAB, 0x3D);
	mipi_dsi_dcs_write_seq(dsi, 0xAC, 0x3C);
	mipi_dsi_dcs_write_seq(dsi, 0xAD, 0x3B);
	mipi_dsi_dcs_write_seq(dsi, 0xAE, 0x3A);
	mipi_dsi_dcs_write_seq(dsi, 0xAF, 0x39);
	mipi_dsi_dcs_write_seq(dsi, 0xB0, 0x38);

	mipi_dsi_dcs_write_seq(dsi, 0xFF, 0x27);
	mipi_dsi_dcs_write_seq(dsi, 0xFB, 0x01);

	mipi_dsi_dcs_write_seq(dsi, 0xD0, 0x11);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x59, 0x78);
	mipi_dsi_dcs_write_seq(dsi, 0x5A, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5B, 0x18);
	mipi_dsi_dcs_write_seq(dsi, 0x5C, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5D, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x5E, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0x5F, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x60, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x61, 0x1C);
	mipi_dsi_dcs_write_seq(dsi, 0x62, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x63, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x64, 0x44);
	mipi_dsi_dcs_write_seq(dsi, 0x65, 0x1B);
	mipi_dsi_dcs_write_seq(dsi, 0x66, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x67, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x68, 0x44);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x9B, 0xBE);

	mipi_dsi_dcs_write_seq(dsi, 0xAB, 0x14);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x62);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0xF8);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x28, 0x1A);
	mipi_dsi_dcs_write_seq(dsi, 0x29, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x66, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x67, 0x96);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x71, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x72, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x79, 0x96);
	mipi_dsi_dcs_write_seq(dsi, 0x7A, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x88, 0x96);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xA5, 0x03);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0xD7);
	mipi_dsi_dcs_write_seq(dsi, 0xDB, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xDC, 0xD7);
	mipi_dsi_dcs_write_seq(dsi, 0x17, 0xCF);
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x0F);
	mipi_dsi_dcs_write_seq(dsi, 0x1B, 0x5B);

	mipi_dsi_dcs_write_seq(dsi, 0xFF, 0x20);

	mipi_dsi_dcs_write_seq(dsi, 0xB0, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x24, 0x00, 0x38, 0x00, 0x4C, 0x00, 0x5E, 0x00, 0x6F, 0x00, 0x7E);
	mipi_dsi_dcs_write_seq(dsi, 0xB1, 0x00, 0x8C, 0x00, 0xBE, 0x00, 0xE5, 0x01, 0x27, 0x01, 0x58, 0x01, 0xA8, 0x01, 0xE8, 0x01, 0xEA);
	mipi_dsi_dcs_write_seq(dsi, 0xB2, 0x02, 0x28, 0x02, 0x71, 0x02, 0x9E, 0x02, 0xDA, 0x03, 0x00, 0x03, 0x31, 0x03, 0x40, 0x03, 0x51);
	mipi_dsi_dcs_write_seq(dsi, 0xB3, 0x03, 0x62, 0x03, 0x75, 0x03, 0x89, 0x03, 0x9C, 0x03, 0xAA, 0x03, 0xB2);

	mipi_dsi_dcs_write_seq(dsi, 0xB4, 0x00, 0x00, 0x00, 0x0D, 0x00, 0x27, 0x00, 0x3D, 0x00, 0x52, 0x00, 0x64, 0x00, 0x75, 0x00, 0x84);
	mipi_dsi_dcs_write_seq(dsi, 0xB5, 0x00, 0x93, 0x00, 0xC5, 0x00, 0xEC, 0x01, 0x2C, 0x01, 0x5D, 0x01, 0xAC, 0x01, 0xEC, 0x01, 0xEE);
	mipi_dsi_dcs_write_seq(dsi, 0xB6, 0x02, 0x2B, 0x02, 0x73, 0x02, 0xA0, 0x02, 0xDB, 0x03, 0x01, 0x03, 0x31, 0x03, 0x41, 0x03, 0x51);
	mipi_dsi_dcs_write_seq(dsi, 0xB7, 0x03, 0x63, 0x03, 0x75, 0x03, 0x89, 0x03, 0x9C, 0x03, 0xAA, 0x03, 0xB2);

	mipi_dsi_dcs_write_seq(dsi, 0xB8, 0x00, 0x00, 0x00, 0x0E, 0x00, 0x2A, 0x00, 0x40, 0x00, 0x56, 0x00, 0x68, 0x00, 0x7A, 0x00, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0xB9, 0x00, 0x98, 0x00, 0xC9, 0x00, 0xF1, 0x01, 0x30, 0x01, 0x61, 0x01, 0xB0, 0x01, 0xEF, 0x01, 0xF1);
	mipi_dsi_dcs_write_seq(dsi, 0xBA, 0x02, 0x2E, 0x02, 0x76, 0x02, 0xA3, 0x02, 0xDD, 0x03, 0x02, 0x03, 0x32, 0x03, 0x42, 0x03, 0x53);
	mipi_dsi_dcs_write_seq(dsi, 0xBB, 0x03, 0x66, 0x03, 0x75, 0x03, 0x89, 0x03, 0x9C, 0x03, 0xAA, 0x03, 0xB2);

	mipi_dsi_dcs_write_seq(dsi, 0xFF, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0xB0, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x24, 0x00, 0x38, 0x00, 0x4C, 0x00, 0x5E, 0x00, 0x6F, 0x00, 0x7E);
	mipi_dsi_dcs_write_seq(dsi, 0xB1, 0x00, 0x8C, 0x00, 0xBE, 0x00, 0xE5, 0x01, 0x27, 0x01, 0x58, 0x01, 0xA8, 0x01, 0xE8, 0x01, 0xEA);
	mipi_dsi_dcs_write_seq(dsi, 0xB2, 0x02, 0x28, 0x02, 0x71, 0x02, 0x9E, 0x02, 0xDA, 0x03, 0x00, 0x03, 0x31, 0x03, 0x40, 0x03, 0x51);
	mipi_dsi_dcs_write_seq(dsi, 0xB3, 0x03, 0x62, 0x03, 0x77, 0x03, 0x90, 0x03, 0xAC, 0x03, 0xCA, 0x03, 0xDA);

	mipi_dsi_dcs_write_seq(dsi, 0xB4, 0x00, 0x00, 0x00, 0x0D, 0x00, 0x27, 0x00, 0x3D, 0x00, 0x52, 0x00, 0x64, 0x00, 0x75, 0x00, 0x84);
	mipi_dsi_dcs_write_seq(dsi, 0xB5, 0x00, 0x93, 0x00, 0xC5, 0x00, 0xEC, 0x01, 0x2C, 0x01, 0x5D, 0x01, 0xAC, 0x01, 0xEC, 0x01, 0xEE);
	mipi_dsi_dcs_write_seq(dsi, 0xB6, 0x02, 0x2B, 0x02, 0x73, 0x02, 0xA0, 0x02, 0xDB, 0x03, 0x01, 0x03, 0x31, 0x03, 0x41, 0x03, 0x51);
	mipi_dsi_dcs_write_seq(dsi, 0xB7, 0x03, 0x63, 0x03, 0x77, 0x03, 0x90, 0x03, 0xAC, 0x03, 0xCA, 0x03, 0xDA);

	mipi_dsi_dcs_write_seq(dsi, 0xB8, 0x00, 0x00, 0x00, 0x0E, 0x00, 0x2A, 0x00, 0x40, 0x00, 0x56, 0x00, 0x68, 0x00, 0x7A, 0x00, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0xB9, 0x00, 0x98, 0x00, 0xC9, 0x00, 0xF1, 0x01, 0x30, 0x01, 0x61, 0x01, 0xB0, 0x01, 0xEF, 0x01, 0xF1);
	mipi_dsi_dcs_write_seq(dsi, 0xBA, 0x02, 0x2E, 0x02, 0x76, 0x02, 0xA3, 0x02, 0xDD, 0x03, 0x02, 0x03, 0x32, 0x03, 0x42, 0x03, 0x53);
	mipi_dsi_dcs_write_seq(dsi, 0xBB, 0x03, 0x66, 0x03, 0x77, 0x03, 0x90, 0x03, 0xAC, 0x03, 0xCA, 0x03, 0xDA);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x35, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x3B, 0x03, 0xAE, 0x1A, 0x04, 0x04);
	msleep(100);
	ret = mipi_dsi_dcs_exit_sleep_mode(dsi);
	if (ret)
		return ret;
